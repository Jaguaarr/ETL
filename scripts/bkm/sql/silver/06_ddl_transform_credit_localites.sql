...
CREATE TABLE silver.bkam_credit_localites (
    ...
    CONSTRAINT chk_silver_credit_loc_dep_pct CHECK (depots_percent IS NULL OR depots_percent BETWEEN 0 AND 100),
    CONSTRAINT chk_silver_credit_loc_cre_pct CHECK (credits_percent IS NULL OR credits_percent BETWEEN 0 AND 100)
);
...
INSERT INTO silver.bkam_credit_localites
    (periode, code_localite, localite, nombre_guichets,

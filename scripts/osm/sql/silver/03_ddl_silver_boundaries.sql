...
===============================================================================
`osm_id` est un identifiant GADM (ex: "MAR.1.1_1"), pas un ID OSM numerique
-- cf. scripts/osm/scraping/scrape_admin_boundaries.py, qui convertit un
GeoJSON GADM/QGIS pre-fourni (aucune requete Overpass). Colonne `text`, pas
`bigint` (verifie en direct : le typage numerique rejetait 100% des lignes).
===============================================================================
*/
